...
// ABSTRACT CLASS
abstract class Reservasi implements ICetak {
    private int id;
...
// SUBCLASS yang mengimplementasikan cetakNota()
...
public class Main {
        ...
        while (true) {
            ...
            try {
                ...
                switch (pilihan) {
                    ...
                    case 6 -> {
                        System.out.println("Terima kasih! Total reservasi dibuat: " + totalReservasi);
                        return;
                    }
    ...
    static void tambahReservasi() {
        try {
            ...
            int idLap = Integer.parseInt(input.nextLine());
            ...
            if (lapangan != null) {
                ...
                totalReservasi++; // STATIC VAR digunakan
                System.out.println("Reservasi berhasil ditambahkan!");
            } else {
                System.out.println("Lapangan tidak ditemukan.");
            }
        } catch (NumberFormatException e) {
            System.out.println("Input angka tidak valid! Reservasi dibatalkan.");
        }
    }
    ...
    static void editReservasi() {
        ...
        try {
            ...
            if (reservasi != null) {
                ...
                reservasi.setDurasi(Integer.parseInt(input.nextLine()));
